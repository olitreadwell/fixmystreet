...
- `2026-09-09` trivial pass (typos in docs/POD/scripts/tests) — outcome: pr-opened (fork PR #7). Lesson: 11 genuine meaning-preserving typo fixes across 8 files (docs/pro-manual/citizens-experience.md Reponses->Responses x2; bin/fixmystreet.com/update_council_user_permissions + update_council_users_without_role + update_roles comma seperated->comma separated x3; perllib/FixMyStreet/App/Controller/Auth.pm reponse->response; perllib/FixMyStreet/App/Controller/Contact.pm neccessary reformating of exiting->necessary reformatting of existing; t/open311.t reponse->response x3; t/app/controller/contact.t succesfully->successfully). UK dialect respected (colour/behaviour/organise correct). Branch fix-typos-in-docs-and-code, commit 79e87eff8a, PR #7 open non-draft base=fork master.
